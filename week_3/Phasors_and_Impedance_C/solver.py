...
def main(argv):
    ...
    if check_tol(V_S,[V1, V2], 5) and check_tol(I, [I1, I2], 5):
        ...
        #
        print("The real portion of overall impedance is %.3f [KOhms] " % (Z_ab.real/1000))
        print("The imaginary portion of overall impedance is %.3f [KOhms] " % (Z_ab.imag/1000))
        print("The magnitude of the current I is %.3f [mA] " %  (I_mag*1000))
        print("The angle of the current I is %.3f [deg] " %  I_ang)
        
        print("The magnitude of the voltage V1 is %.3f [V] " % V1_mag)
        print("The angle of the voltage V1 is %.3f [deg] " %  V1_ang)
        
        print("The magnitude of the voltage V2 is %.3f [V] " % V2_mag)
        print("The angle of the voltage V2 is %.3f [deg] " %  V2_ang)
        
        print("The magnitude of the current I1 is %.3f [mA] " % (I1_mag*1000))
        print("The angle of the current I1 is %.3f [deg] " %  I1_ang)
        
        print("The magnitude of the current I2 is %.3f [mA] " % (I2_mag*1000))
        print("The angle of the current I2 is %.3f [deg] " %  I2_ang)
